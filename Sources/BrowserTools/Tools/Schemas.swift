...
/// code hardcodes: the private agent names tools and params as bare strings in six files, and the
/// desktop app carries an allow-list. Both assert equality against this.
///
